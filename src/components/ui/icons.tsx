export const Icons = {
  ...
  Presentation: () => (
    <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 4V2a1 1 0 011-1h8a1 1 0 011 1v2m0 0V1h2a1 1 0 011 1v18a1 1 0 01-1 1H5a1 1 0 01-1-1V2a1 1 0 011-1h2v3M9 12l2 2 4-4" />
    </svg>
  ),
